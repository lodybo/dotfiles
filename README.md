...
This repo is my collection of dotfiles that I use across setups (like personal and work computers). It provides a sensible default for my work environment.
